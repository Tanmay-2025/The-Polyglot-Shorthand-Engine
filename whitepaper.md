...
- **Deployment.** No hosted service was built; a local Gradio demo (`src/app.py`) is included in the repository for interactive testing of both the intent and sentiment models, but production deployment (API serving, containerization, monitoring) was out of scope for this project.
